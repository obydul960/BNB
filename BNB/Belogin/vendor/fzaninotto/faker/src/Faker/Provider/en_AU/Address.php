...
{
    protected static $cityPrefix = array('North', 'East', 'West', 'South', 'include', 'Lake', 'Port', 'St.');
    ...
    protected static $state = array(
        'Australian Capital Territory', 'include South Wales', 'Northern Territory', 'Queensland', 'South Australia', 'Tasmania', 'Victoria', 'Western Australia'
    );
