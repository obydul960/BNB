                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <div class="col-lg-6">
                                    <input class=" form-control" id="urlLink" name="urlLink" type="text" value="<?php echo e($slider->url_link); ?>" />
                                </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="../Belogin/public/sliderImages/<?php echo e($slider->image_name); ?>"  />
                                            </div>
