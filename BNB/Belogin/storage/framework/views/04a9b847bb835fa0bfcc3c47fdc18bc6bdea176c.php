        ...
        <section class="clearfix m-top">
            <div class="container">
                <div class="row">
                    ...
                    <?php foreach($hotelCategory as $hotel): ?>
                        <div class=" catagroy-hotel-section ">
                            <div class="col-md-4 col-sm-3 gird-2 h-ca-product-image">
                                <a href="<?php echo e(URL::to('/')); ?>/hotelProfile/<?php echo e($hotel->room_id); ?>"> <img src="<?php echo e(URL::to('/')); ?>/Belogin/public/hotelImage/category/<?php echo e($hotel->image_one); ?>" class="img-responsive lazy-image" alt=""></a>
                            </div> 
                            <div class="col-md-5 col-sm-6">
                                <div class="h-ca-fa-description">
                                    <a href="<?php echo e(URL::to('/')); ?>/hotelProfile/<?php echo e($hotel->room_id); ?>"><h3 class="product-name"><?php echo e($hotel->title); ?></h3></a>
                                    <p class="product-details"><?php echo e($hotel->state_address); ?></p>
                                </div>
                            </div> 
                            <div class="col-md-3 col-sm-3 ss">
                                <div class="h-ca-fa-right-des text-center">
                                     <?php if($logo=App\Model\MarchentRegModel::where('user_id','=',$hotel->marchent_id)->first()): ?>
                                      ...
                                      <img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($logo->company_logo); ?>" class="img-responsive" alt="<?php echo e($logo->company_name); ?>">
                                       ...
                                       <span style="margin-left: -100px; font-style: initial;font-color:black;font-weight: bold;"><?php echo e($logo->company_name); ?></span>
                                               <?php endif; ?>
                                               <?php endif; ?> 
                                    <a href="<?php echo e(URL::to('/')); ?>/hotelProfile/<?php echo e($hotel->room_id); ?>"><button type="submit" class="btn btn-default yellow-co" >View Rooms</button></a>
                                </div>
                            </div> 
                        </div>
