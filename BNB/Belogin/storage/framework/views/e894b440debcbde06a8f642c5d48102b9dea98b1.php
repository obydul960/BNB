...
<section class=" clearfix main-menu5 menu-main z-depth-1" id="header">
    ...
    <li class="tab col s2 menu-name1"><a  href="<?php echo e(URL::to('/')); ?>" id="addNewInvoiceBtn">Home</a></li>
                <?php if($m2=App\Model\MainManuModel::where('status',1)->where('manu_indexing',2)->first()): ?>
                 <li class="tab col s2 menu-name1">
                <a   href="<?php echo e(URL::to('/')); ?>/fushaion/<?php echo e($m2->id); ?>" target="_Self"><?php echo e($m2->manu_name); ?></a>
                </li>
                 <?php endif; ?>
                <?php if($m6=App\Model\MainManuModel::where('status',1)->where('manu_indexing',6)->first()): ?>
                <li class="tab col s2 menu-name1"><a href="<?php echo e(URL::to('/')); ?>/fushaion/<?php echo e($m6->id); ?>" target="_Self"><?php echo e($m6->manu_name); ?></a></li> 
                <?php endif; ?>
                <?php if($m5=App\Model\MainManuModel::where('status',1)->where('manu_indexing',5)->first()): ?>
                 <li class="tab col s2 menu-name3"><a href="<?php echo e(URL::to('/')); ?>/fushaion/<?php echo e($m5->id); ?>" target="_Self"><?php echo e($m5->manu_name); ?></a></li>
                <?php endif; ?>

                
                <?php if($m3=App\Model\MainManuModel::where('status',1)->where('manu_indexing',3)->first()): ?>
                <li class="tab col s2 menu-name2"><a href="" target="_Self"><?php echo e($m3->manu_name); ?></a></li>
                <?php endif; ?>

                 <?php if($m4=App\Model\MainManuModel::where('status',1)->where('manu_indexing',4)->first()): ?>
                 <li class="tab col s2"><a href="" target="_Self"><?php echo e($m4->manu_name); ?></a></li>
                 <?php endif; ?> 
            </ul>
