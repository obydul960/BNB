                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <?php echo Form::open(['url'=>['manageRoomUpdate',$manageRoomEdit->id],'class'=>' form-horizontal','method'=>'post','enctype' => 'multipart/form-data','files'=>true]); ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="araName" class=" form-control">
                                            <option><?php echo e($manageRoomEdit->area); ?></option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="locationName" class=" form-control">
                                            <option><?php echo e($manageRoomEdit->location); ?></option>
                                            <?php foreach($hotelListShow as $hotelList): ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="hotelName" class=" form-control">
                                            <option><?php echo e($manageRoomEdit->hotel_name); ?></option>
                                            <?php foreach($hotelListShow as $hotelList): ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <input class="form-control" id="title" name="title" type="text" value="<?php echo e($manageRoomEdit->title); ?>" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="firstname" class="control-label col-lg-3">Room Number</label>
                                    <div class="col-lg-6">
                                        <input class="form-control" id="title" name="roomNumber" type="text" value="<?php echo e($manageRoomEdit->room_number); ?>" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="firstname" class="control-label col-lg-3">Price </label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="price" name="price" type="text" value="<?php echo e($manageRoomEdit->price); ?>" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="firstname" class="control-label col-lg-3">Commission</label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="commission" name="commission" type="text" value="<?php echo e($manageRoomEdit->commission); ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-3 col-sm-3">Discription</label>
                                    <div class="col-lg-8 col-sm-9">
                                        <textarea class="form-control ckeditor" id="discrioption" name="discrioption" rows="6" ><?php echo e($manageRoomEdit->discription); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
