                        ...
                        <div class="col-md-4 col-sm-4 clearfix mobile-overflow mobile-ho-p ">
                            <div class=" h-de-fa-left ">
                                <div class="zoom-wrapper">
                                    <div class="zoom-left">
                                    <img style="border: 1px solid #e8e8e6;" id="zoom_09" src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/category_image/<?php echo e($fashionDeatils->home_Cat_image); ?>" 
                                                                data-zoom-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/category_image/<?php echo e($fashionDeatils->home_Cat_image); ?>" width="350" />
                                        <div id="gallery_09">
                                            <a href="#" class="elevatezoom-gallery active" data-update="" 
                                               data-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_one); ?>" 
                                               data-zoom-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_one); ?>">
                                                <img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_one); ?>" width="100" /></a> 
                                            <a style="display: block;" href="#" class="elevatezoom-gallery" 
                                               data-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_two); ?>" 
                                               data-zoom-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_two); ?>">
                                                <img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_two); ?>" width="100" /></a> 
                                            <a href="tester" class="elevatezoom-gallery" data-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_three); ?>" 
                                               data-zoom-image="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_three); ?>"> 
                                                <img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/details_image/<?php echo e($fashionDeatils->details_image_three); ?>" width="100" /></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-7 clearfix fashion-details-product-section bg-shadow" style="margin-bottom: 20px;">
                            <div class="">
                                <div class="h-de-fa-right">
                                    <h2 class="product-name"><?php echo e($fashionDeatils->product_name); ?></h2>
                                    <h3 class="product-price"><?php echo e($fashionDeatils->selling_price); ?> <span>৳</span></h3>
                                </div>
                                <div class="fashion-product-code-section"> 
                                    <div class="product-code pull-left">
                                        <h4 class="product-price">Product Code: <span><?php echo e($fashionDeatils->code_no); ?></span></h4>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div style="height: auto;" id="collapse2" class="accordion-body panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                    ...
                                    <div class="col-md-7 col-xs-12">
                                        <?php echo $fashionDeatils->product_details; ?>
                    ...
                    <div class="h-de-fa-related-product">
                        ...
                        <div class="cata-fashion-h ">
                            <div class="">
                                ...
                                <?php foreach($relatedProduct as $productName): ?>
                                    <li class="" style="">
                                        <div class="content-box single-product ">
                                            <div class="h-ca-fa-body  fashion-Tourism-home">
                                                <div class=" h-ca-product-image text-center">
                                                    <a href="<?php echo e(URL::to('/')); ?>/details/<?php echo e($productName->product_id); ?>"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/category_image/<?php echo e($productName->home_Cat_image); ?>" class="img-responsive lazy-image" alt=""></a>
                                                </div>
                                                <div class="brand-logo-cata text-center">
                                                    <?php if($logo=App\Model\MarchentRegModel::where('user_id','=',$productName->marchent_id)->first()): ?>
                                       ...
                                       <span style="margin-left: -100px; font-style: initial;font-color:black;font-weight: bold;"><?php echo e($logo->company_name); ?></span>
                                               ...
                                               <?php endif; ?> 
                                                ...
                                                <div class="tittle-description-ca-h text-center">
                                                    <a href="catagory_fashoion-details.html"><h3 class="product-name "><?php echo e($productName->product_name); ?> </h3></a>
                                                    <h4 class="price-catagory"><?php echo e($productName->selling_price); ?> <span>৳</span></h4>
                                                </div>
