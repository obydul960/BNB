                ...
                <div class="row">
                        ...
                        <div class="user-menu-section z-depth-1">
                            <div class="user-profile">
                                ...
                                <div class="user-name text-center">
                                    <h3><?php echo e($urserInfo->name); ?></h3>
                                </div>
                            </div>
                            <ul>
                    ...
                    <div class="col-md-8 col-sm-8 m-top">
                        <div class="user-form-section clearfix z-depth-1">
                            <div class="col-md-11">
                            <?php echo Form::open(['url'=>['userprofileUpdate',$urserInfo->user_id],'class'=>'form-horizontal']); ?>

                                <!-- <form action="#"> -->
                                    <div class="input-field col s12">
                                        <input placeholder="User Name" type="text" name="fullName" value="<?php echo e($urserInfo->name); ?>">
                                        <label for="first_name" class="active">First Name</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input placeholder="Email"  type="email" name="email" value="<?php echo e($urserInfo->email); ?>">
                                        <label for="first_name" class="active">Your Email</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input placeholder="+880" type="text" name="mobile" value="<?php echo e($urserInfo->phone); ?>">
                                        <label for="first_name" class="active">Mobile Number</label>
                                    </div>
                                    <div class="input-field col s12">
                                    <label for="first_name" class="active">Gender</label>
                                        <select class="select" name="gender">
                                            <option value="0"  selected><?php echo e($urserInfo->gender); ?></option>
                                    ...
                                    <label for="first_name" class="active">City</label>
                                        <select class="select"  name="city">
                                            <option value="0" selected><?php echo e($urserInfo->city); ?></option>
                                    ...
                                    <label for="first_name" class="active">District</label>
                                        <select class="select"  name="district">
                                            <option value="0"  selected><?php echo e($urserInfo->district); ?></option>
                                            <option value="1">Dhaka</option>
                                            <option value="2">Feni</option>
                                        </select>
                                    </div>
