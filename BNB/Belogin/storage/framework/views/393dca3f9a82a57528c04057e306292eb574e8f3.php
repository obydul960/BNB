                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Tourist\PackageImageModel::where('package_id','=',$value->package_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->category_image!=null): ?>
                                                                <img src="public/touristImage/category/<?php echo e($packageImageShow->category_image); ?>" alt=""  />
                                                            <?php else: ?>
                                                                <img src="public/commonImage/common.png" alt="" style="width: 150px; height: 150px;" />
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    </div>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Tourist\PackageImageModel::where('package_id','=',$value->package_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->details_image!=null): ?>
                                                                <img src="public/touristImage/details/<?php echo e($packageImageShow->details_image); ?>" alt=""  style="width: 150px; height: 150px;" />
                                                            <?php else: ?>
                                                                <img src="public/commonImage/common.png" alt="" style="width: 150px; height: 150px;" />
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Tourist\PackageImageModel::where('package_id','=',$value->package_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->home_image_one!=null): ?>
                                                                <img src="public/touristImage/details/<?php echo e($packageImageShow->home_image_one); ?>" alt=""  style="width: 150px; height: 150px;" />
                                                            <?php else: ?>
                                                                <img src="public/commonImage/common.png" alt="" style="width: 150px; height: 150px;" />
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Tourist\PackageImageModel::where('package_id','=',$value->package_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->home_image_two!=null): ?>
                                                                <img src="public/touristImage/details/<?php echo e($packageImageShow->home_image_two); ?>" alt="" style="width: 150px; height: 150px;"  />
                                                            <?php else: ?>
                                                                <img src="public/commonImage/common.png" alt="" style="width: 150px; height: 150px;" />
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
