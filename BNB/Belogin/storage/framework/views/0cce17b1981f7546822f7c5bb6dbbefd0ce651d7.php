                ...
                <div class="panel-body">
                    <div class="form">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                                <input class=" form-control" id="price" name="price" type="number" value="<?php echo e($manageRoomEdit->price); ?>" />
                            </div>
                        </div>
                        <div class="form-group ">
                            <label for="firstname" class="control-label col-lg-3">Commission</label>
                            <div class="col-lg-6">
                                <input class=" form-control" id="commission" name="commission" type="number" value="<?php echo e($manageRoomEdit->commission); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-3 col-sm-3">Discription</label>
                            <div class="col-lg-8 col-sm-9">
                                <textarea class="form-control ckeditor" id="discrioption" name="discrioption" rows="6"><?php echo $manageRoomEdit->discription; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
