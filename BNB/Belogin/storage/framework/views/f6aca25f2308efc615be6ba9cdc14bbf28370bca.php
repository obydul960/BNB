                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <button id="btn_add" name="btn_add" class="btn btn-success pull-left "><a href="<?php echo e(url('marchentRoomAdd')); ?>"><i class="fa fa-plus-circle"></i>  New Room</a></button>
                            <div class="adv-table">
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Hotel\HotelImageModel::where('room_id','=',$value->room_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->image_one!=null): ?>
                                                                <img src="/hotelImage/category/<?php echo e($packageImageShow->image_one); ?>" alt=""  />
                                                            <?php else: ?>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Hotel\HotelImageModel::where('room_id','=',$value->room_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->image_two!=null): ?>
                                                                <img src="/hotelImage/details/<?php echo e($packageImageShow->image_two); ?>" alt=""/>
                                                            <?php else: ?>
                                                                <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt=""  style="width: 150px; height: 150px;"/>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Hotel\HotelImageModel::where('room_id','=',$value->room_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->imge_three!=null): ?>
                                                                <img src="/hotelImage/details/<?php echo e($packageImageShow->imge_three); ?>" alt=""  />
                                                            <?php else: ?>
                                                                <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" style="width: 150px; height: 150px;" />
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                                        <?php foreach($productImage=App\Model\Hotel\HotelImageModel::where('room_id','=',$value->room_id)->get() as $packageImageShow): ?>
                                                            <?php if($packageImageShow->image_four!=null): ?>
                                                                <img src="/hotelImage/details/<?php echo e($packageImageShow->image_four); ?>" alt=""  />
                                                            <?php else: ?>
                                                                <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" style="width: 150px; height: 150px;"/>
                                                            <?php endif; ?>
                                                        <?php endforeach; ?>
