               ...
               <div class="row">
                   <div class="clearfix clear-display">
                           ...
                           <div class="h-populer-band ">
                               ...
                               <ul class="h-populer-band-list ">
                                   <li  class="demo-card-wide ">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsOne->id); ?>"  id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsOne->company_logo); ?>" class="img-responsive lazy-image"></a>

                                   </li>
                             
                                   <li  class="demo-card-wide ">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsTwo->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsTwo->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                                 
                                   <li  class="demo-card-wide ">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsThree->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsThree->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                              
                                   <li  class="demo-card-wide " >
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsFour->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsFour->company_logo); ?>" class="img-responsive lazy-image"> </a>
                                   </li>
                                                               
                                   <li  class="demo-card-wide  " >
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsFive->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsFive->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                               
                                   <li  class="demo-card-wide store-pop-right">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsSix->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsSix->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                                 
                                   <li  class="demo-card-wide ">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsSeven->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsSeven->company_logo); ?>"></a>
                                   </li>
                                                                
                                   <li  class="demo-card-wide " >
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsEight->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsEight->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                                
                                   <li  class="demo-card-wide " >
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsNine->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsNine->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                                                                
                                   <li  class="demo-card-wide  h-po-band-logo">
                                       <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsTen->id); ?>" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsTen->company_logo); ?>" class="img-responsive lazy-image"></a>
                                   </li>
                               </ul>
                           </div>
                       </div>
                       <div class="col-md-3 col-sm-4 col-xs-12 gird-right">
                           <div class="h-add">
                               <a href="<?php echo e(URL::to('/')); ?>/companyProfile/<?php echo e($popularBrandsTwo->id); ?>"><img src="<?php echo e(URL::to('/')); ?>/Belogin/public/product_image/logo/<?php echo e($popularBrandsOne->company_logo); ?>" class="img-responsive lazy-image"></a>
                           </div>
                       </div>
                   </div>
               </div>
                                       ...
                                       <div class="content-box single-product ">
                                           <div class="h-ca-fa-body  fashion-Tourism-home">
                                               <div class=" h-ca-product-image text-center">
                                                   <a href="catagory_fashoion-details.html"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/details/product-3-a-medium-notinclude.png" class="img-responsive lazy-image" alt=""></a>
                                               </div>
