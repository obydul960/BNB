               ...
               <div class="row">
                   <div class="clearfix clear-display">
                           ...
                           <div class="h-populer-band ">
                               ...
                               <ul class="h-populer-band-list ">
                                   <li  class="demo-card-wide ">
                                       <a href="store-company-profile.html"  id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/Bata.png" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide ">
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/KFC.jpg" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide ">
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/alibaba.jpg" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide " >
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/amazon-offer.png" class="img-responsive lazy-image"> </a>
                                   </li>
                                   <li  class="demo-card-wide  " >
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/flipkart-offer.png" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide store-pop-right">
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/foodpanda-offer.png" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide ">
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/KFC.jpg" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide " >
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/robi.jpg" class="img-responsive lazy-image"></a>
                                   </li>
                                   <li  class="demo-card-wide " >
                                       <a href="store-company-profile.html" id="bigimage"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/populer_Bands/alibaba.jpg" class="img-responsive lazy-image"></a>
                                   </li>
                       ...
                       <div class="col-md-3 col-sm-4 col-xs-12 gird-right">
                           <div class="h-add">
                               <a href="#"><img src="<?php echo e(URL::to('/')); ?>/webassets/image/add/Citygroup.jpg" class="img-responsive lazy-image"></a>
                           </div>
                       </div>
                   </div>
               </div>
