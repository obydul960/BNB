                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                ...
                                <table  class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    @foreach($serechManageProduct as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button  class="productDelete btn btn-danger" data-item-id="{{$value->product_id}}">Delete</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                    ...
                    $('#mainCat').change(function(){
                        ...
                        $.get("{{ url('api/dropdown/subcategory')}}",
                                ...
                                function(data) {
                                    var model = $('#subcat');
                                    model.empty();
                                    model.append("<option value=''>" + 'Select Subcategory hhh' + "</option>");
