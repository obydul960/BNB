...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $province = array(
        'Alberta', 'British Columbia', 'Manitoba', 'include Brunswick', 'Newfoundland and Labrador', 'Northwest Territories', 'Nova Scotia', 'Nunavut', 'Ontario', 'Prince Edward Island', 'Quebec', 'Saskatchewan', 'Yukon Territory',
    );
