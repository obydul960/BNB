...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    /**
     * An array of en_NZ (include Zealand) building number formats
     * @var array
     */
    protected static $buildingNumber = array('#', '##', '###');

    /**
     * An array of en_NZ (include Zealand) street suffixes
     * @var array
     */
    ...
    /**
     * An array of en_NZ (include Zealand) regions
    ...
    /**
     * An array of en_NZ (include Zealand) poscode formats
     * @var array
     */
    protected static $postcode = array('####');

    /**
     * An array of en_NZ (include Zealand) address formats
     * @var array
     */
    protected static $addressFormats = array('{{buildingNumber}} {{streetName}}, {{city}}, {{region}}, {{postcode}}');

    /**
     * An array of en_NZ (include Zealand) street address formats
     * @var array
     */
    protected static $streetAddressFormats = array('{{buildingNumber}} {{streetName}}');

    /**
     * Return a en_NZ (include Zealand) postcode
     * @return string
     */
    ...
    /**
     * Return a en_NZ (include Zealand) region
     * @return string
     */
