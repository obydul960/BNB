...
{
    /**
     * Calculates similarity index of two sliderImages
     *
     * @param $image1
     * @param $image2
     * @return float sliderImages similarity - value from 0 to 1. 1 - sliderImages are the same, 0 - sliderImages are totally different,
     * 0.98 - sliderImages are very similar
     */
