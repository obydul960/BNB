                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="araName" class=" form-control">
                                            <option>{{ $manageRoomEdit->area }}</option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="locationName" class=" form-control">
                                            <option>{{ $manageRoomEdit->location }}</option>
                                            @foreach($hotelListShow as $hotelList)
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="hotelName" class=" form-control">
                                            <option>{{ $manageRoomEdit->hotel_name }}</option>
                                            @foreach($hotelListShow as $hotelList)
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="price" name="price" type="text" value="{{ $manageRoomEdit->price }}" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="firstname" class="control-label col-lg-3">Commission</label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="commission" name="commission" type="text" value="{{ $manageRoomEdit->commission }}" />
                                    </div>
                                </div>
                                <div class="form-group">
