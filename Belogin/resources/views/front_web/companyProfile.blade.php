...
@section('content')
        ...
        <section class=" clearfix  cart-mobile">    
            <div class="container search-bg store-company-section ">
                <div class="row ">
                    <div class=" col-md-3">
                        <div class="store-company-logo">
                            <img src="Assets/image/populer_Bands/flipkart-offer.png" class="img-responsive" alt="bata">
                        </div>
                    </div>
                    <div class=" col-md-2">
                        <div class="media company-store-info">
                            <div class="media-left company-store-icon">
                                <i class="fa fa-mobile fa-lg" aria-hidden="true"></i>
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">01824143370</h4>
                            </div>
                        </div>
                    </div>
                    <div class=" col-md-3">
                        <div class="media company-store-info">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">www.buynbooking.com</h4>
                            </div>
                        </div>
                    </div>
                    <div class=" col-md-4">
                        <div class="media company-store-info">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Eastern Plus Commercial Complex, Suit# 10/A, 7th Floor, 
                                    145 Shanti Nagar Road,Dhaka-1217.</h4>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="content-box single-product ">
                                <div class="h-ca-fa-body-pa">
                                    <div class=" h-ca-product-image text-center">
                                        <a href="catagory_fashoion-details.html"><img src="Assets/image/details/fashion-product-2.jpg" class="img-responsive lazy-image" alt=""></a>
                                    </div>
