                    ...
                    <div class="col-md-9 col-sm-7 col-xs-12 gird-left " style="box-shadow: 0 2px 3px 0 rgba(177, 168, 168, 0.3),0 2px 5px 0 rgba(189, 183, 183, 0.1);">
                        <div class="demo-card-wide1" >
                            <div id="main-slider" class="slider-pro">
                                <div class="sp-slides">
                                @foreach($slider=App\Model\SliderModel::orderBy('id','DESC')->take(5)->get() as $sliderImage)
                           
                                    <div class="sp-slide">
                                        <a href="{{$sliderImage->url_link}}">
                                            <img class="sp-image lazy-image"
                                                 src="{{URL::to('/')}}/Belogin/public/sliderImages/{{$sliderImage->image_name}}"
                                                 data-src="{{URL::to('/')}}/Belogin/public/sliderImages/{{$sliderImage->image_name}}" >
                                        </a>  
                                    </div>
                                @endforeach  
                                   <!--  <div class="sp-slide">
                                        <a href="catagory_fashoion.html">
                                            <img class="sp-image lazy-image"
                                                 src="{{URL::to('/')}}/webassets/image/slider/3.jpg"
                                                 data-src="{{URL::to('/')}}/webassets/image/slider/3.jpg" >
                                        </a>
                                    ...
                                    <div class="sp-slide">
                                        <a href="catagory_fashoion.html">
                                            <img class="sp-image lazy-image"
                                                 src="{{URL::to('/')}}/webassets/image/slider/22.jpg"
                                                 data-src="{{URL::to('/')}}/webassets/image/slider/22.jpg" >
                                        </a>
                                    </div>
                                    <div class="sp-slide">
                                        <a href="catagory_fashoion.html">
                                            <img class="sp-image lazy-image"
                                                 src="{{URL::to('/')}}/webassets/image/slider/2.jpg"
                                                 data-src="{{URL::to('/')}}/webassets/image/slider/2.jpg" >
                                        </a>
                                    </div>
                                    <div class="sp-slide">
                                        <a href="catagory_fashoion.html">
                                            <img class="sp-image lazy-image"
                                                 src="{{URL::to('/')}}/webassets/image/slider/3.png"
                                                 data-src="{{URL::to('/')}}/webassets/image/slider/3.jpg" >
                                        </a>
                                    </div> -->
                                    ...
                                    @foreach($slider as $sliderImage)
                                        <div class="sp-thumbnail">
                                            <div class="sp-thumbnail-text">
                                                <div class="sp-thumbnail-title"> {{$sliderImage->image_title }}</div>
                                                <div class="sp-thumbnail-description">
                                                {!! $sliderImage->slider_details !!}
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach    
                    ...
                    <div class="col-md-3 col-sm-5 col-xs-12 clearfix gird-right ">
                        <div class="best-seller ">
                            ...
                            <div class="h-ca-product-image">
                                <a href="#" id="bigimage"><img src="{{URL::to('/')}}/webassets/image/add/Citygroup.jpg" class="img-responsive lazy-image" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
